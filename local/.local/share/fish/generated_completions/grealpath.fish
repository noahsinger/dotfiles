...
complete -c grealpath -l relative-to --description 'print the resolved path relative to DIR.'
complete -c grealpath -l relative-base --description 'print absolute paths unless paths below DIR.'
